"""
Inspection Log — SQLite database layer  (Phase 2 upgrade)
==========================================================
New columns vs Phase 1:
  bounding_boxes  TEXT  — JSON array of box dicts [{x1,y1,x2,y2,confidence,severity}]
  box_count       INT   — pre-computed length of bounding_boxes list
  detection_mode  TEXT  — "detection" | "classification" | "mock"

Backward compatible: Phase 1 rows without those columns get defaults.
"""
